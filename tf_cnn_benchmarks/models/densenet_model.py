...
def create_densenet40_k12_model(params):
  return DensenetCifar10Model('densenet40-k12', (12, 12, 12), 12)


def create_densenet100_k12_model(params):
  return DensenetCifar10Model('densenet100-k12', (32, 32, 32), 12)


def create_densenet100_k24_model(params):
  return DensenetCifar10Model('densenet100-k24', (32, 32, 32), 24)

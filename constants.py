...
perf_file_header = ["GPU","Model","BatchSize","Optimizer","Epoch","Dataset","Resource","avg Idle time","avg Active time","avg Peak consumption"]
...
training_perf_filename = './data/training_perf_file.csv'
...
job_done_report =  '{0}_{1}_{2}_{3}_{4} has Finished at '  # {0} gpu, {1} model, {2} bsize, {3} opt, {4} _epoch, {5} time
